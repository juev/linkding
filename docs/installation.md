...
This guide applies to the Go port of linkding v1.47.0. The examples use release tag `v1.47.0`; choose a newer tag from [GitHub Releases](https://github.com/juev/linkding/releases) when available. To build from source, follow the [README](../README.md).
...
```sh
cd linkding_v1.47.0_linux_amd64
...
services:
  linkding:
    image: ghcr.io/juev/linkding:v1.47.0
    ports:
      - "9090:9090"
    user: "10001:10001"
    read_only: true
