...
var profileHelp = map[string]string{
	...
	"bookmark_description_max_lines":  "Limits the number of lines that are displayed for each bookmark description.",
	"display_url":                     "When enabled, this setting displays the bookmark URL below the title.",
	"permanent_notes":                 "Whether to show bookmark notes permanently, without having to toggle them individually.",
	...
	"sticky_pagination":               "When enabled, the pagination controls will stick to the bottom of the screen.",
	"collapse_side_panel":             "When enabled, the tags side panel will be collapsed by default.",
	...
	"legacy_search":                   "Enable the legacy search engine.",
	"tag_grouping":                    "In alphabetical mode, tags will be grouped by the first letter.",
	"auto_tagging_rules":              "Automatically adds tags to bookmarks based on predefined rules.",
	"enable_favicons":                 "Automatically loads favicons for bookmarked websites and displays them next to each bookmark.",
	"enable_preview_images":           "Automatically loads preview images for bookmarked websites and displays them next to each bookmark.",
	"web_archive_integration":         "Automatically create snapshots of bookmarked websites on the Internet Archive Wayback Machine.",
	"enable_sharing":                  "Allows to share bookmarks with other users, and to view shared bookmarks.",
	"enable_public_sharing":           "Makes shared bookmarks publicly accessible, without requiring a login.",
	"enable_automatic_html_snapshots": "Automatically creates HTML snapshots when adding bookmarks.",
	"default_mark_unread":             "Sets the default state for the Mark as unread option when creating a new bookmark.",
	"default_mark_shared":             "Sets the default state for the Share option when creating a new bookmark.",
